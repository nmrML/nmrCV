 ...
 * [nmrCV.yml](nmrCV.yml)
     * Determines how your purl.obolibrary.org/obo/nmrCV/ redirects will be handled
     ...
     * Paste in the contents of [nmrCV.yml](nmrCV.yml)
 ...
 * [nmrCV.md](nmrCV.md)
     ...
     * Paste in the contents of [nmrCV.md](nmrCV.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
